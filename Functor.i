#line 1 "Source/HonoursProj/Types/Functor.h"
#pragma once
...
#line 4 "Source/HonoursProj/Types/Functor.h"
...
UNBRACKET (template <>) class Functor<Maybe UNBRACKET (<>)> : public BaseFunctor<Maybe, A> { private: UNBRACKET (template <>) inline static auto _fmap = [](Function<B, A> func, Maybe<A> f_a) -> Maybe<B> { if (f_a._isNothing) { return Maybe<B>::Nothing(); } else { return Maybe<B>::Just(func(f_a._value)); } }; public: UNBRACKET (template <>) inline static auto fmap = curry(_fmap UNBRACKET (<>)); UNBRACKET () };;
#line 182 "Source/HonoursProj/Types/Functor.h"
